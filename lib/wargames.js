...
function Wargames(app, options) {
	...
	self.initiateCaching(function () {
		...
		self.gitfeed = new botrss(self.bot, self.bitly,
									self.settings.rssList[0],
									self.settings);
		self.twitfeed = new botrss(self.bot, self.bitly,
									self.settings.rssList[1],
									self.settings);
		self.cussfeed = new botrss(self.bot, self.bitly,
									self.settings.rssList[2],
									self.settings);
	});
};
